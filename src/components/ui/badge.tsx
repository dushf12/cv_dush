  ...
  'inline-flex items-center rounded-full px-3 py-1 text-xs font-medium text-nowrap transition-all duration-200 ease-in-out transform shadow-sm',
  {
    variants: {
      variant: {
        ...
        outline:
          'border border-border bg-muted/80 backdrop-blur-sm text-muted-foreground hover:bg-muted/70 hover:scale-105 hover:shadow-md dark:bg-white/20 dark:text-white dark:border-white/40 dark:hover:bg-white/30',
        info:
